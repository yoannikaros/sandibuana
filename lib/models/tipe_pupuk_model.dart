class TipePupukModel {
  ...
  factory TipePupukModel.fromMap(Map<String, dynamic> map) {
    return TipePupukModel(
      id: map['id'],
      nama: map['nama'],
      kode: map['kode'],
  ...
  @override
  String toString() {
    return 'TipePupukModel(id: $id, nama: $nama, kode: $kode, aktif: $aktif)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TipePupukModel && other.id == id;
  }
